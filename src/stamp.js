...
class Stamp {
	...
	/**
	 * @desc Generates a new pdf with a read only text box at the provided coordinates and dimensions
	 ...
	 */
	placeholder( img, page, { width, height, x, y } ) {
		return new Promise( ( fulfill, reject ) => {
			...
			//tmpPdf.textAnnotation(x, y, width, height, 'click to sign')
	 ...
	 */
	position( pdfFilePath ) {
		return new Promise( ( fulfill, reject ) => {
			pdfParser.on( "pdfParser_dataError", errData => console.error( errData.parserError ) );
			pdfParser.on( "pdfParser_dataReady", pdfData => {
				fs.writeFile( '/tmp/pdf.json', JSON.stringify( pdfData ), err => {
...
let subject = new Stamp( '/home/cory/Documents/fw9.pdf' )
...
// subject.placeholder( dataImg, { width: 200, height: 75, x: 140, y: 490 } )
// 	.then( what => {
// 		console.log( what )
// 	} )
// 	.catch( e => {
...
subject.position( '/tmp/placeholderStamped.pdf' )
	.then( what => {
		console.log( what )
	} )
	.catch( e => {
