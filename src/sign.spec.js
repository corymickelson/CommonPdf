...
test('Digital Signature (PoDoFo)', (t) => __awaiter(this, void 0, void 0, function* () {
    const signer = new sign_1.Sign(path_1.join(__dirname, '../test-data/de542.pdf'), path_1.join(__dirname, '../test-data/ca.cert'), path_1.join(__dirname, '../test-data/ca.key'), { reason: 'SkySlope' });
