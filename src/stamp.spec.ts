...
import { Stamp as Subject, StampContract } from './stamp'
...
test( 'burst', t => {
	let contract: StampContract = {
			file: join( __dirname, '../node_modules/commonpdf_testfiles/fw9.pdf' ),
			stamps: [],
			page: 1
		},
		stamp = new Subject( contract )
	stamp.burst()
		.then( pages => {
			t.plan( 1 )
